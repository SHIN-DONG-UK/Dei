...
class C104_RAG():
    def __init__(self):
        ...
        self.CHROMA_DB_PATH = "/home/god/robot_ws/src/llm_pkg/rag_db"
...
def main():
    rag = C104_RAG()
    prompt = """
            아래는 검색된 문서입니다. 이를 기반으로 질문에 답변하세요.
            문서의 핵심 내용을 먼저 요약하고, 그 다음 사용자의 질문에 답하세요.
    ...
    # print(rag.generate_rag_response(prompt, query))
    print(rag.getResult(query))
